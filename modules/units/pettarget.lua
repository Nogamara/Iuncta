...
local styleName = addon.unitPrefix .. 'PetTarget'
...
local focus = oUF:Spawn('pettarget')
focus:SetPoint('RIGHT', addon.units.pet, 'LEFT', -addon.SPACING, 0)
addon:PixelPerfect(focus)

-- expose internally
addon.units.pettarget = focus
